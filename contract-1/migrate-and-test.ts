...
console.log('\nCompiling DefaultPermsZkApp with new o1js...');
const { verificationKey: newVK } = await DefaultPermsZkApp.compile();
...
finalState.assertEquals(postUpgradeValue);
console.log('State correctly reflects the post-upgrade update.');
